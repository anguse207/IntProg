...
def gatherInput(): #this function creates a new window and gathers user input with text entry
...
def main():
    windowSize,c1,c2,c3 = gatherInput() #call gatherInput() to get inputs
